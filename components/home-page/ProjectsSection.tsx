        ...
        <ScrollAnimation direction="up" delay={0.1}>
          <div className="mb-16">
            ...
            <p className="text-lg md:text-xl text-muted-foreground max-w-2xl leading-relaxed">
              A showcase of recent work and personal experiments that
              demonstrate my approach to solving problems
            </p>
          </div>
        </ScrollAnimation>
        ...
        <div className="grid md:grid-cols-2 gap-4 lg:gap-6">
          {projects.map((project, index) => (
            <ScrollAnimation
              ...
              delay={0.2 + index * 0.1}
            >
              <Card className="group relative overflow-hidden border-border/50 dark:border-border/30 bg-card/50 dark:bg-card/30 backdrop-blur-sm hover:border-primary/50 dark:hover:border-primary/60 transition-all duration-500 hover:shadow-2xl hover:shadow-primary/10 dark:hover:shadow-primary/20">
                {/* Image Container */}

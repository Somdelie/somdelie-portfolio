            ...
            <div className="space-y-6 relative">
              ...
              <div className="relative">
                <p className="text-lg md:text-xl text-muted-foreground leading-relaxed pl-6">
                  ...
                  with specialization in both backend and frontend development.
                  With{" "}
              ...
              <p className="text-base md:text-lg text-muted-foreground/90 leading-relaxed">
                ...
                the intersection of design and development, crafting experiences
                that are both visually stunning and meticulously optimized for
                performance.
              </p>
            </div>
